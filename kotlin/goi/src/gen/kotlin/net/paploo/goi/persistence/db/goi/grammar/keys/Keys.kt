...
val EXAMPLE__EXAMPLE_RULE_ID_FKEY: ForeignKey<ExampleRecord, RuleRecord> = Internal.createForeignKey(Example.EXAMPLE, DSL.name("example_rule_id_fkey"), arrayOf(Example.EXAMPLE.RULE_ID), net.paploo.goi.persistence.db.goi.grammar.keys.RULE_PKEY, arrayOf(Rule.RULE.ID), true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION)
val EXAMPLE_REFERENCE__EXAMPLE_REFERENCE_EXAMPLE_ID_FKEY: ForeignKey<ExampleReferenceRecord, ExampleRecord> = Internal.createForeignKey(ExampleReference.EXAMPLE_REFERENCE, DSL.name("example_reference_example_id_fkey"), arrayOf(ExampleReference.EXAMPLE_REFERENCE.EXAMPLE_ID), net.paploo.goi.persistence.db.goi.grammar.keys.EXAMPLE_PKEY, arrayOf(Example.EXAMPLE.ID), true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION)
val EXAMPLE_REFERENCE__EXAMPLE_REFERENCE_LESSON_CODE_FKEY: ForeignKey<ExampleReferenceRecord, LessonRecord> = Internal.createForeignKey(ExampleReference.EXAMPLE_REFERENCE, DSL.name("example_reference_lesson_code_fkey"), arrayOf(ExampleReference.EXAMPLE_REFERENCE.LESSON_CODE), LESSON_PKEY, arrayOf(Lesson.LESSON.CODE), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val RULE_REFERENCE__RULE_REFERENCE_LESSON_CODE_FKEY: ForeignKey<RuleReferenceRecord, LessonRecord> = Internal.createForeignKey(RuleReference.RULE_REFERENCE, DSL.name("rule_reference_lesson_code_fkey"), arrayOf(RuleReference.RULE_REFERENCE.LESSON_CODE), LESSON_PKEY, arrayOf(Lesson.LESSON.CODE), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val RULE_REFERENCE__RULE_REFERENCE_RULE_ID_FKEY: ForeignKey<RuleReferenceRecord, RuleRecord> = Internal.createForeignKey(RuleReference.RULE_REFERENCE, DSL.name("rule_reference_rule_id_fkey"), arrayOf(RuleReference.RULE_REFERENCE.RULE_ID), net.paploo.goi.persistence.db.goi.grammar.keys.RULE_PKEY, arrayOf(Rule.RULE.ID), true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION)
