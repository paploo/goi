...
open class ConjugationRecord private constructor() : UpdatableRecordImpl<ConjugationRecord>(Conjugation.CONJUGATION) {
     ...
     */
    constructor(id: UUID, conjugationSetId: UUID, politenessCode: String, chargeCode: String, formCode: String, sortRank: Int?, value: String): this() {
        this.id = id
