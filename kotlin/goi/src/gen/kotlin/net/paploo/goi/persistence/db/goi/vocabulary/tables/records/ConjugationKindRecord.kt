...
open class ConjugationKindRecord private constructor() : UpdatableRecordImpl<ConjugationKindRecord>(ConjugationKind.CONJUGATION_KIND) {
     ...
     */
    constructor(code: String, label: String, wordClassCode: String): this() {
        this.code = code
        this.label = label
