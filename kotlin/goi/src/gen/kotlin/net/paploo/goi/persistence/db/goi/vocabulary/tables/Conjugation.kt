...
open class Conjugation(
     ...
     */
    fun conjugationCharge(): ConjugationChargePath = conjugationCharge
    val conjugationCharge: ConjugationChargePath by lazy { ConjugationChargePath(this, CONJUGATION__CONJUGATION_CHARGE_CODE_FKEY, null) }

    /**
     * Get the implicit join path to the <code>vocabulary.conjugation_set</code>
     * table.
     */
    fun conjugationSet(): ConjugationSetPath = conjugationSet
    val conjugationSet: ConjugationSetPath by lazy { ConjugationSetPath(this, CONJUGATION__CONJUGATION_CONJUGATION_SET_ID_FKEY, null) }

    /**
     * Get the implicit join path to the
     * <code>vocabulary.conjugation_form</code> table.
     */
    fun conjugationForm(): ConjugationFormPath = conjugationForm
    val conjugationForm: ConjugationFormPath by lazy { ConjugationFormPath(this, CONJUGATION__CONJUGATION_FORM_CODE_FKEY, null) }

    /**
     * Get the implicit join path to the
     * <code>vocabulary.conjugation_politeness</code> table.
     */
    fun conjugationPoliteness(): ConjugationPolitenessPath = conjugationPoliteness
    val conjugationPoliteness: ConjugationPolitenessPath by lazy { ConjugationPolitenessPath(this, CONJUGATION__CONJUGATION_POLITENESS_CODE_FKEY, null) }
