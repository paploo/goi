  ...
  module Model
    module Vocabulary
      ...
      class Definition
        ...
        def self.create_id_in_linkage(vocabulary_id, linkage_field)
        ...
        def initialize(id: nil,vocabulary_id:, value:, sort_rank: 1)
          @id = id || self.class.create_id(vocabulary_id, value)
      ...
      class Spelling
        ...
        # Create an ID that is consistent for a given set of fields.
        # This makes database syncing scripts hard because any updates to the values change the ID!
        ...
        def initialize(id: nil,vocabulary_id:, spelling_kind_code:, value:)
          @id = id || self.class.create_id(vocabulary_id, spelling_kind_code, value)
          @vocabulary_id = vocabulary_id
